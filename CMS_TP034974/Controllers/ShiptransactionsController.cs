...
namespace CMS_TP034974.Controllers
{
    public class ShiptransactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "shiptranId,shipName,DepartLocation,DestinationLocation")] Shiptransaction shiptransaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "shiptranId,shipName,DepartLocation,DestinationLocation")] Shiptransaction shiptransaction)
        {
            if (ModelState.IsValid)
            {
