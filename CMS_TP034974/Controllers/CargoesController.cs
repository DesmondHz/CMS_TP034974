...
namespace CMS_TP034974.Controllers
{
    public class CargoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CargoId,CustomerID,CargoWeight,CargoWidth,CargoLength,CargoHeight,CargoName,CargoRequirement,CargoWarehouse")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CargoId,CustomerID,CargoWeight,CargoWidth,CargoLength,CargoHeight,CargoName,CargoRequirement,CargoWarehouse")] Cargo cargo)
        {
            if (ModelState.IsValid)
            {
